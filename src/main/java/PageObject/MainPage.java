...
public class MainPage {
    ...
    private final By createOrderButton = By.xpath(".//button[text() = 'Оформить заказ']"); /*Кнопка оформить заказ(появляется, когда залогинишься)*/
    ...
    @Step
            ("Login via loginAccountButton")
    public void clickLoginAccountButton() {
        driver.findElement(LogInMain).click();
    }

    @Step
            ("Login via accountProfileButton")
